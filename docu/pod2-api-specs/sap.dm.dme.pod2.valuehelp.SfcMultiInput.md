...
`sap.dm.dme.pod2.valuehelp.SfcMultiInput`
...
```
new SfcMultiInput (sIdopt, mSettingsopt)
```
...
|------|------|----------|-------------|
| `sId` | string | sap.dm.dme.pod2.valuehelp.$SfcMultiInputSettings | Yes | If not a string, the first argument will be used as mSettings instead. |
| `mSettings` | sap.dm.dme.pod2.valuehelp.$SfcMultiInputSettings | Yes |  |
...
| Name | Type | Optional | Description |
|------|------|----------|-------------|
| `oEvent` | sap.dm.dme.pod2.valuehelp.SfcMultiInput$SelectionChangeEvent | No |  |
