...
`sap.dm.dme.pod2.widget.core.ClockWidget`
...
### (static) PropertyId :Enum.<string>

An enumeration of widget property IDs supported by this widget.

### (static) TimeFormat :Enum.<string>

An enumeration of time formats supported by this widget.
...
Updates the control's text and starts a new timeout.
