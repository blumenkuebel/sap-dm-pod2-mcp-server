# OperationActivityValueHelpDialog

`sap.dm.dme.pod2.valuehelp.OperationActivityValueHelpDialog`
...
```
new OperationActivityValueHelpDialog (sIdopt, mSettingsopt)
```
...
|------|------|----------|-------------|
| `sId` | string | sap.dm.dme.pod2.valuehelp.$OperationActivityValueHelpDialogSettings | Yes | If not a string, the first argument will be used as mSettings instead. |
| `mSettings` | sap.dm.dme.pod2.valuehelp.$OperationActivityValueHelpDialogSettings | Yes |  |
...
| Name | Type | Optional | Description |
|------|------|----------|-------------|
| `oEvent` | sap.dm.dme.pod2.valuehelp.OperationActivityValueHelpDialog$ConfirmEvent | No |  |
