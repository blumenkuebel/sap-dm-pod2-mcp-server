# GoodsReceiptQuantityProgressWidget

`sap.dm.dme.pod2.widget.order.GoodsReceiptQuantityProgressWidget`

A preconfigured progress indicator widget bound to the order planned and completed quantities.

**Extends:** [sap.dm.dme.pod2.widget.core.ProgressIndicatorWidget](sap.dm.dme.pod2.widget.core.ProgressIndicatorWidget.md)

## Constructor

```
new GoodsReceiptQuantityProgressWidget ()
```
