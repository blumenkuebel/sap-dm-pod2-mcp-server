...
`sap.dm.dme.pod2.context.type.Plant`

Information about the user's currently selected plant.

**Extends:** [sap.dm.dme.pod2.context.PodContextObject](sap.dm.dme.pod2.context.PodContextObject.md)

**Implements:** [sap.dm.dme.pod2.context.type.$PlantProperties](sap.dm.dme.pod2.context.type.$PlantProperties.md)

## Constructor

```
new Plant (oProperties)
```
