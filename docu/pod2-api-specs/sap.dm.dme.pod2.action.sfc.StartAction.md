...
### _getRequest () → {sap.dm.dme.pod2.api.execution.StartSfcRequest}

Get the request object for the SFC start v2 API.

🔧 This method may be overridden by custom subclasses.

🔧 This method may be overridden by custom subclasses.

**Returns:** sap.dm.dme.pod2.api.execution.StartSfcRequest - [sap.dm.dme.pod2.api.execution.StartSfcRequest](sap.dm.dme.pod2.api.execution.md#.StartSfcRequest)

### _getToastMessage) (oOptionsopt) → {string}

Gets the toast message to show when the start is successful.
...
### _isOperationActivityStartable (oOperation) → {boolean}

Checks if the operation activity can be started.
...
| Name | Type | Optional | Description |
|------|------|----------|-------------|
| `oOperation` | sap.dm.dme.pod2.context.type.BaseOperationWorkItem | null | No | The operation activity to check. |

**Returns:** boolean - boolean

### _isSfcStartable (oWorkListItem) → {boolean}

Checks if the SFC can be started.
...
| Name | Type | Optional | Description |
|------|------|----------|-------------|
| `oWorkListItem` | sap.dm.dme.pod2.context.type.BaseWorkListItem | No | The work list item to check. |
...
| Name | Type | Optional | Description |
|------|------|----------|-------------|
| `oRequest` | sap.dm.dme.pod2.api.execution.StartSfcRequest | No | The start request sent to the server. |
...
and refreshes the work list if the work list contains the started SFC(s).
...
|------|------|----------|-------------|
| `oRequest` | sap.dm.dme.pod2.api.execution.StartSfcRequest | No | The start request sent to the server. |
| `oResponse` | sap.dm.dme.pod2.api.execution.StartSfcResponse | No | The response received from the server. |
