# SelectOperationActivityWidget

`sap.dm.dme.pod2.widget.filter.SelectOperationActivityWidget`

A preconfigured OperationActivitySingleInput bound to the first filter operation activity.
...
```
new SelectOperationActivityWidget (oConfig)
```
