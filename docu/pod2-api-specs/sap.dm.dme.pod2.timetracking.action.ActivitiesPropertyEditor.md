# ActivitiesPropertyEditor

`sap.dm.dme.pod2.timetracking.action.ActivitiesPropertyEditor`

## Members

### _eMode :sap.dm.dme.pod2.timetracking.action.ActivitiesPropertyEditor.Mode

### _oIndirectLaborAction :sap.dm.dme.pod2.timetracking.action.BaseIndirectLaborAction

### (static) Mode :Enum.<string>
