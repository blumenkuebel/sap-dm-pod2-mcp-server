...
`sap.dm.dme.pod2.action.resource.RefreshResourcesAction`

Action to refresh the filter resources in the POD context by re-fetching each one from the backend.
