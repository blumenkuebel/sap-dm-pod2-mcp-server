...
`sap.dm.dme.pod2.widget.filter.SelectResourceWidget`

A preconfigured ResourceSingleInput bound to the first filter resource.
...
```
new SelectResourceWidget (oConfig)
```
