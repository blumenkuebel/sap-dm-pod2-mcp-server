# RoutingValueHelpDialog

`sap.dm.dme.pod2.valuehelp.RoutingValueHelpDialog`
...
```
new RoutingValueHelpDialog (sIdopt, mSettingsopt)
```
...
|------|------|----------|-------------|
| `sId` | string | sap.dm.dme.pod2.valuehelp.$RoutingValueHelpDialogSettings | Yes | If not a string, the first argument will be used as mSettings instead. |
| `mSettings` | sap.dm.dme.pod2.valuehelp.$RoutingValueHelpDialogSettings | Yes |  |
...
| Name | Type | Optional | Description |
|------|------|----------|-------------|
| `oEvent` | sap.dm.dme.pod2.valuehelp.RoutingValueHelpDialog$ConfirmEvent | No |  |
