...
`sap.dm.dme.pod2.valuehelp.SfcValueHelpDialog`
...
```
new SfcValueHelpDialog (sIdopt, mSettingsopt)
```
...
|------|------|----------|-------------|
| `sId` | string | sap.dm.dme.pod2.valuehelp.$SfcValueHelpDialogSettings | Yes | If not a string, the first argument will be used as mSettings instead. |
| `mSettings` | sap.dm.dme.pod2.valuehelp.$SfcValueHelpDialogSettings | Yes |  |
...
| Name | Type | Optional | Description |
|------|------|----------|-------------|
| `oEvent` | sap.dm.dme.pod2.valuehelp.SfcValueHelpDialog$ConfirmEvent | No |  |
