...
### (static) Properties :Object.<string, boolean>

Default values for Serialize configuration.
...
### _getSerializeRequest () → {sap.dm.dme.pod2.api.execution.SerializeSfcRequest}

Creates the payload for the serialize API.

🔧 This method may be overridden by custom subclasses.

🔧 This method may be overridden by custom subclasses.

**Returns:** sap.dm.dme.pod2.api.execution.SerializeSfcRequest - [sap.dm.dme.pod2.api.execution.SerializeSfcRequest](sap.dm.dme.pod2.api.execution.md#.SerializeSfcRequest)

### _onSerializeError (oRequest, oError)

Handles when SFC serialization fails. The default implementation logs the error and shows an error message.
...
|------|------|----------|-------------|
| `oRequest` | sap.dm.dme.pod2.api.execution.SerializeSfcRequest | No | The serialize SFC request. |
| `oError` | Error | No | The error that occurred. |

### _onSerializeSuccess (oRequest, oResponse)

Handles when SFC serialization is successful. The default implementation updates the model and shows a
success message.
...
|------|------|----------|-------------|
| `oRequest` | sap.dm.dme.pod2.api.execution.SerializeSfcRequest | No | The serialize SFC request. |
| `oResponse` | sap.dm.dme.pod2.api.execution.SerializeSfcResponse | No | The serialize SFC response. |
...
| Name | Type | Optional | Description |
|------|------|----------|-------------|
| `oRequest` | sap.dm.dme.pod2.api.execution.SerializeSfcRequest | No | The payload for the serialize API. |
