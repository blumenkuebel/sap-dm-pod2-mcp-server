...
`sap.dm.dme.pod2.context.type.Downtime`

**Extends:** [sap.dm.dme.pod2.context.PodContextObject](sap.dm.dme.pod2.context.PodContextObject.md)

**Implements:** [sap.dm.dme.pod2.context.type.$DowntimeProperties](sap.dm.dme.pod2.context.type.$DowntimeProperties.md)
...
|------|------|----------|-------------|
| `oProperties` | sap.dm.dme.pod2.context.type.$DowntimeProperties | No | An object that satisfies sap.dm.dme.pod2.context.type.$DowntimeProperties |
