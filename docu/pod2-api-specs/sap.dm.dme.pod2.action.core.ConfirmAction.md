...
`sap.dm.dme.pod2.action.core.ConfirmAction`

Action to show a confirmation dialog allowing the user to confirm or cancel. If the user cancels no further
...
|------|------|----------|-------------|
| `oConfig` | sap.dm.dme.pod2.action.ActionConfig | No |  |
