# BindStringPropertyEditor

`sap.dm.dme.pod2.propertyeditor.BindStringPropertyEditor`

Property editor that allows binding expressions to be used for the property's value.
...
```
new BindStringPropertyEditor (oPropertyAccessor, sProperty)
```
