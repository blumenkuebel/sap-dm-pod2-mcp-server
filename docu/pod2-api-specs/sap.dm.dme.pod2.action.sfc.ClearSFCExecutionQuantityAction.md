# ClearSFCExecutionQuantityAction

`sap.dm.dme.pod2.action.sfc.ClearSFCExecutionQuantityAction`

Action to clear the execution quantity value in the POD Context.
...
```
new ClearSFCExecutionQuantityAction ()
```
