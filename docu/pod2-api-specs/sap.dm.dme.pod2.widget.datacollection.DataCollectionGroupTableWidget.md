...
```
new DataCollectionGroupTableWidget (oConfig)
```
...
### _oTableModel :sap.ui.model.json.JSONModel
...
|------|------|----------|-------------|
| `oConfig` | sap.dm.dme.pod2.widget.WidgetConfig | No |  |
| `mSettings` | sap.m.$TableSettings | No |  |
...
Override the parent _getModelPath method to specify the model path within PodContext's model
...
### _getProgressDisplayValue (oDcGroup) → {string}
...
| Name | Type | Optional | Description |
|------|------|----------|-------------|
| `oDcGroup` | sap.dm.dme.pod2.context.type.DataCollectionGroup | No |  |

**Returns:** string - string

### _getProgressPercentValue (oDcGroup) → {number}
...
### _getProgressState (bAllDataCollected) → {sap.ui.core.ValueState}
...
| Name | Type | Optional | Description |
|------|------|----------|-------------|
| `bAllDataCollected` | boolean | No |  |

**Returns:** sap.ui.core.ValueState - sap.ui.core.ValueState
...
### _setSelectedDataCollectionGroup (oDataCollectionGroup)

Selects the specified data collection group in the table.
...
| Name | Type | Optional | Description |
|------|------|----------|-------------|
| `oDataCollectionGroup` | sap.dm.dme.pod2.context.type.DataCollectionGroup | null | No | The data collection group to select. If null, clears the selection. |
