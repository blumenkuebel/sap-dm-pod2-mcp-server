...
`sap.dm.dme.pod2.valuehelp.MaterialSingleInput`
...
```
new MaterialSingleInput (sIdopt, mSettingsopt)
```
...
|------|------|----------|-------------|
| `sId` | string | sap.dm.dme.pod2.valuehelp.$MaterialSingleInputSettings | Yes | If not a string, the first argument will be used as mSettings instead. |
| `mSettings` | sap.dm.dme.pod2.valuehelp.$MaterialSingleInputSettings | Yes |  |

## Properties

| Name | Type | Optional | Description |
|------|------|----------|-------------|
| `_oSelection` | sap.dm.dme.pod2.context.type.Material | No | The selected object. This property should be treated as protected and only accessed/modified directly by the control. Use `getValue`, `setValue`, `getSelection`, and `setSelection` instead. |
...
| Name | Type | Optional | Description |
|------|------|----------|-------------|
| `oEvent` | sap.dm.dme.pod2.valuehelp.MaterialSingleInput$SelectionChangeEvent | No |  |
