# BindBooleanPropertyEditor

`sap.dm.dme.pod2.propertyeditor.BindBooleanPropertyEditor`

**Extends:** [sap.dm.dme.pod2.propertyeditor.BooleanPropertyEditor](sap.dm.dme.pod2.propertyeditor.BooleanPropertyEditor.md)

## Constructor

```
new BindBooleanPropertyEditor (oPropertyAccessor, sProperty, bDefaultValueopt)
```
