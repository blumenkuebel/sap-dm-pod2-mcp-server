# SFCQuantityProgressWidget

`sap.dm.dme.pod2.widget.order.SFCQuantityProgressWidget`

A preconfigured progress indicator widget bound to the SFC planned and completed quantities.
