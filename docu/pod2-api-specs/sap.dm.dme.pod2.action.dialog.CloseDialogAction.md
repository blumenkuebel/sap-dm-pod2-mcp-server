...
Action to close the dialog the button is embedded in.
...
|------|------|----------|-------------|
| `oActionContext` | sap.dm.dme.pod2.action.ActionContext | No | Contextual information for the action. |
...
Executes the action to close the dialog the button is embedded in.
