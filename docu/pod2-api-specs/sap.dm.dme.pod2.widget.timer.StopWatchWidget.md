...
`sap.dm.dme.pod2.widget.timer.StopWatchWidget`
...
| Name | Type | Optional | Description |
|------|------|----------|-------------|
| `nTime` | number | No | The time in milliseconds. |
...
Cleans up the timer interval when the widget is destroyed.
