# NotificationStateIconWidget

`sap.dm.dme.pod2.widget.notification.NotificationStateIconWidget`

A widget that displays an icon indicating the current POD notification WebSocket connection state.

**Extends:** [sap.dm.dme.pod2.widget.core.IconWidget](sap.dm.dme.pod2.widget.core.IconWidget.md)

## Constructor

```
new NotificationStateIconWidget ()
```
...
### (static) CONNECTED_BACKGROUND_COLOR :string

The background color of the Icon when connected.

### (static) CONNECTED_ICON :string

The icon to display when the notification WebSocket is connected.

### (static) DISCONNECTED_BACKGROUND_COLOR :string

The background color of the Icon when disconnected.

### (static) DISCONNECTED_ICON :string

The icon to display when the notification WebSocket is disconnected.
...
### (static) ICON_COLOR :string

The color of the icon.

### INCLUDE_EVENTS :Array.<string>
...
### constructor :TypeOf.<sap.dm.dme.pod2.widget.notification.NotificationStateIconWidget>
