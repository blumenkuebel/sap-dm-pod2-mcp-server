...
Action to start an operation/phase.
...
|------|------|----------|-------------|
| `oRequest` | sap.dm.dme.pod2.api.execution.StartSfcRequest | No |  |
...
Returns the request object used to start the phase.
...
### (async) _startPhase (oRequest) → {Promise.<void>}
