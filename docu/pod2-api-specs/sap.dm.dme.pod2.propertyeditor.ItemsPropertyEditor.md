...
`sap.dm.dme.pod2.propertyeditor.ItemsPropertyEditor`

A property editor for configuring a list of items with key and text values. Supports adding, editing, reordering,
and deleting items.
...
```
new ItemsPropertyEditor (oPropertyAccessor, sProperty)
```
