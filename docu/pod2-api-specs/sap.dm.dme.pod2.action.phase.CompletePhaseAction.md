...
Action to complete an operation/phase.
...
|------|------|----------|-------------|
| `oRequest` | sap.dm.dme.pod2.api.execution.CompletePhaseRequest | No |  |
...
### (async) _completePhase (oRequest) → {Promise.<void>}

Completes the selected phase.
...
### _getRequest () → {sap.dm.dme.pod2.api.execution.CompletePhaseRequest}

Returns the request object used to complete the phase.

🔧 This method may be overridden by custom subclasses.

🔧 This method may be overridden by custom subclasses.

**Returns:** sap.dm.dme.pod2.api.execution.CompletePhaseRequest - [sap.dm.dme.pod2.api.execution.CompletePhaseRequest](sap.dm.dme.pod2.api.execution.md#.CompletePhaseRequest)
...
Snapshot PodContext values in case they change in a prior step.
