# ActivityConfirmationTableWidget

`sap.dm.dme.pod2.widget.activityconfirmation.ActivityConfirmationTableWidget`
...
```
new ActivityConfirmationTableWidget ()
```
...
### _bAllowUomFlag :boolean

### _bEnablePostingDate :boolean

### _bYieldOrScrapReported :boolean

Indicates if yield or scrap was reported for the current step.

### _sCustomFieldProperty :string
...
### _createReportActvitiyHandler () → {sap.dm.dme.pod2.widget.activityconfirmation.ReportActivityContentHandler}

Returns the handler instance for reporting activity.

🔧 This method may be overridden by custom subclasses.

🔧 This method may be overridden by custom subclasses.

**Returns:** sap.dm.dme.pod2.widget.activityconfirmation.ReportActivityContentHandler - [sap.dm.dme.pod2.widget.activityconfirmation.ReportActivityContentHandler](sap.dm.dme.pod2.widget.activityconfirmation.ReportActivityContentHandler.md)
...
### _createTable (oTableConfig) → {sap.m.Table}

Creates a table with a header toolbar.
...
| Name | Type | Optional | Description |
|------|------|----------|-------------|
| `oTableConfig` | object | No | The table configuration. |
...
Creates the toolbar for the activity confirmation table.
...
Returns the model path for activity summaries.
...
Checks if the report button should be enabled based on the current context.
...
Handles the "Report Activity" button press event.
Opens the report activity dialog with the current configuration and activity summaries.

🔧 This method may be overridden by custom subclasses.

🔧 This method may be overridden by custom subclasses.

### (async) onViewPostingButtonPress (oEvent) → {Promise.<void>}

Handles the press event for the postings button in a table row.
...
| Name | Type | Optional | Description |
|------|------|----------|-------------|
| `oEvent` | sap.m.Button$PressEvent | No | The event object from the button press. |
