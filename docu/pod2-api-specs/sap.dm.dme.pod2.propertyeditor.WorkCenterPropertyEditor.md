...
```
new WorkCenterPropertyEditor (oPropertyAccessor, sProperty, oOptionsopt)
```
...
| `multiSelect` | boolean | Yes | True if the property editor is for multiple work centers. |
