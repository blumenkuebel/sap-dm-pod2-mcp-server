# SFCExecutionQuantityWidget

`sap.dm.dme.pod2.widget.sfc.SFCExecutionQuantityWidget`

A preconfigured input widget bound to the SFC Quantity.

**Extends:** [sap.dm.dme.pod2.widget.core.InputWidget](sap.dm.dme.pod2.widget.core.InputWidget.md)

## Constructor

```
new SFCExecutionQuantityWidget ()
```
...
Properties that can contain a binding expression
...
### (static) getDefaultConfig) (sIdopt) → {sap.dm.dme.pod2.widget.DefaultWidgetConfig}
