...
`sap.dm.dme.pod2.valuehelp.BomValueHelpDialog`
...
```
new BomValueHelpDialog (sIdopt, mSettingsopt)
```
...
|------|------|----------|-------------|
| `sId` | string | sap.dm.dme.pod2.valuehelp.$BomValueHelpDialogSettings | Yes | If not a string, the first argument will be used as mSettings instead. |
| `mSettings` | sap.dm.dme.pod2.valuehelp.$BomValueHelpDialogSettings | Yes |  |
...
| Name | Type | Optional | Description |
|------|------|----------|-------------|
| `oEvent` | sap.dm.dme.pod2.valuehelp.BomValueHelpDialog$ConfirmEvent | No |  |
