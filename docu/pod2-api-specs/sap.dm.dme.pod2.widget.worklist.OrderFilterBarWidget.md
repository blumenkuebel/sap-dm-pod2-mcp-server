...
`sap.dm.dme.pod2.widget.worklist.OrderFilterBarWidget`
...
### constructor :TypeOf.<sap.dm.dme.pod2.widget.worklist.OrderFilterBarWidget>
...
The initial value for the given filter is also set to the model as returned by
...
### _getFilterGroupItem (sFilterName) → {sap.ui.comp.filterbar.FilterGroupItem|undefined}
...
**Returns:** sap.ui.comp.filterbar.FilterGroupItem|undefined - sap.ui.comp.filterbar.FilterGroupItem |  undefined

### _getInitialFilterValue (sFilterName) → {any}

Returns the initial value for the given filter. Where applicable, a current POD Context value takes priority,
followed by a URL parameter, with a fallback to the configured default.
...
Update preview controls during design-time.
...
workCenters - Multi-select with value help (stored in the model as full objects)
