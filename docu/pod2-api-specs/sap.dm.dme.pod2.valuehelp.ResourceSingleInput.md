...
`sap.dm.dme.pod2.valuehelp.ResourceSingleInput`
...
```
new ResourceSingleInput (sIdopt, mSettingsopt)
```
...
|------|------|----------|-------------|
| `sId` | string | sap.dm.dme.pod2.valuehelp.$ResourceSingleInputSettings | Yes | If not a string, the first argument will be used as mSettings instead. |
| `mSettings` | sap.dm.dme.pod2.valuehelp.$ResourceSingleInputSettings | Yes |  |

## Properties

| Name | Type | Optional | Description |
|------|------|----------|-------------|
| `_oDataAccess` | sap.dm.dme.pod2.valuehelp.$ResourceSingleInputDataAccess | No | The actual data access strategy for the instance. |
| `_oSelection` | sap.dm.dme.pod2.context.type.Resource | No | The selected object. This property should be treated as protected and only accessed/modified directly by the control. Use `getValue`, `setValue`, `getSelection`, and `setSelection` instead. |
...
| Name | Type | Optional | Description |
|------|------|----------|-------------|
| `oEvent` | sap.dm.dme.pod2.valuehelp.ResourceSingleInput$SelectionChangeEvent | No |  |
