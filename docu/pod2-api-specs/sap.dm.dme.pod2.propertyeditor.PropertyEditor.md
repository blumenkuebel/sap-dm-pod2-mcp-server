...
Base class for property editors which define how a widget or action configuration property is edited.

**Extends:** [sap.dm.dme.pod2.propertyeditor.$PropertyAccessor](sap.dm.dme.pod2.propertyeditor.$PropertyAccessor.md)

## Constructor

```
new PropertyEditor (oPropertyAccessor, sPropertyId)
```
...
|------|------|----------|-------------|
| `oPropertyAccessor` | sap.dm.dme.pod2.propertyeditor.$PropertyAccessor | No | The Widget, Action, or other PropertyAccessor to edit. |
...
### (abstract) (abstract) getControl () → {sap.ui.core.Control}

Gets the control used to edit the property shown in the POD Designer's property editor panel. Subclasses
