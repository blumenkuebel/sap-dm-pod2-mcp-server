# ReportedQuantitySummaryWidget

`sap.dm.dme.pod2.widget.quantityconfirmation.ReportedQuantitySummaryWidget`
...
```
new ReportedQuantitySummaryWidget ()
```
...
Gets the model for the widget. This is used to bind the table to the data.
...
Gets the model path for the widget. This is used to bind the table to the data.
...
Overrides the getDefaultConfig method to provide the default configuration for the widget.
