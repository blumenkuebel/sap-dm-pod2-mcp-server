# RefreshOperationActivitiesAction

`sap.dm.dme.pod2.action.worklist.RefreshOperationActivitiesAction`

Refreshes the operation activities list based on the currently selected work list item.
...
```
new RefreshOperationActivitiesAction ()
```
...
Enumeration of all configuration property IDs.
