# WorkInstructionTableWidget

`sap.dm.dme.pod2.widget.workinstruction.WorkInstructionTableWidget`
...
```
new WorkInstructionTableWidget ()
```
...
Returns the current sorting settings, with a default if none are configured.
