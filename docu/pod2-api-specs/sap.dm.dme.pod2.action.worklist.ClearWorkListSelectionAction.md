# ClearWorkListSelectionAction

`sap.dm.dme.pod2.action.worklist.ClearWorkListSelectionAction`

Action to clear the work list selection in the POD Context.

This action clears:

Selected work list items
Operation activities list
Selected operation activities list
...
```
new ClearWorkListSelectionAction ()
```
