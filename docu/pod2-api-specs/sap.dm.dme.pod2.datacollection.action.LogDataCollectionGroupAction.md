# LogDataCollectionGroupAction

`sap.dm.dme.pod2.datacollection.action.LogDataCollectionGroupAction`

Responsible for logging the DC Parameters against an SFC.
...
```
new LogDataCollectionGroupAction ()
```
...
|------|------|----------|-------------|
| `oActionContext` | sap.dm.dme.pod2.action.ActionContext | No | Action context |
