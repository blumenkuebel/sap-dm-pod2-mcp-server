# WorkInstructionHeaderTextWidget

`sap.dm.dme.pod2.widget.workinstruction.WorkInstructionHeaderTextWidget`

A widget to display the header text elements of the current work instructions.

**Extends:** [sap.dm.dme.pod2.widget.core.ExpandableTextWidget](sap.dm.dme.pod2.widget.core.ExpandableTextWidget.md)

## Constructor

```
new WorkInstructionHeaderTextWidget ()
```
...
Updates the text based on the current work instructions.
