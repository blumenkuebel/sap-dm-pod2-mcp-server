...
`sap.dm.dme.pod2.widget.ComponentWidget`

The base class for widgets that depend on an SAPUI5 component with Component.js and manifest.json files.

Widgets that do not need to be implemented as a Component should extend [sap.dm.dme.pod2.widget.Widget](sap.dm.dme.pod2.widget.Widget.md)
instead.
...
### constructor :TypeOf.<sap.dm.dme.pod2.widget.ComponentWidget>
...
### (static) getComponentModels () → {Object.<string, sap.ui.model.Model>}

Models which should be applied to the ComponentContainer. Component models are normally declared in the
manifest.json file, however by passing them through the container you can reuse models already declared in
the widget file.
...
**Returns:** Object.<string, sap.ui.model.Model> - Object.<string, sap.ui.model.Model>
...
### (abstract) (abstract, static) getComponentName () → {string}

The module path to your Component.js, not including the "Component" suffix.

For example, if your Component.js is located at "acme/widget/customWidget/Component.js", the component name
would be "acme.widget.customWidget". Refer to the `name` parameter in the
`sap.ui.core.Component.create` documentation for more information.
...
**See also:** [https://sapui5.hana.ondemand.com/sdk/#/api/sap.ui.core.Component%23methods/sap.ui.core.Component.create](https://sapui5.hana.ondemand.com/sdk/#/api/sap.ui.core.Component%2523methods/sap.ui.core.Component.create)

**See also:** [https://sapui5.hana.ondemand.com/sdk/#/api/sap.ui.core.Component](https://sapui5.hana.ondemand.com/sdk/#/api/sap.ui.core.Component)
