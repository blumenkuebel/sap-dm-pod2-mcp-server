# SelectWorkCenterWidget

`sap.dm.dme.pod2.widget.filter.SelectWorkCenterWidget`

A preconfigured WorkCenterSingleInput bound to the first filter work center.
...
```
new SelectWorkCenterWidget (oConfig)
```
